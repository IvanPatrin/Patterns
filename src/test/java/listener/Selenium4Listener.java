...
public class Selenium4Listener implements WebDriverListener {
    ...
    public void afterFindElement(WebDriver driver, By locator, WebElement result) {
        ...
        try {
            ...
            counter++;
            ImageIO.write(screenshot.getImage(), "png", new File("temp\\ScreenshotElement-" + counter + ".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void afterFindElements(WebDriver driver, By locator, List<WebElement> result) {
        ...
        try {
            Screenshot screenshot = new AShot()
                    ...
                    .takeScreenshot(driver);
            counter++;
            ImageIO.write(screenshot.getImage(), "png", new File("temp\\ScreenshotElements-" + counter + ".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        JavaScriptHelper.scrollTo(0,0);
